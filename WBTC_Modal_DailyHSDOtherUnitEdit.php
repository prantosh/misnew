...
$user_id = $_SESSION['USER_ID'];
 ...
 $query=mysqli_query($cstccon,"select * from cstcmis.veh_hsd_other_depot where id='$id_new' ")or die(mysqli_error());
		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="post" action="WBTC_DailyHSDOtherUnitEdit.php"  enctype="multipart/form-data">
...
?></select></div></td>
						...
						<tr>
							...
							<td>QUANTITY ISSUED : </td>
                                                        ...
                                                        <td ><div class="col-md-14"><input value="<?php echo $qty1 ; ?>"class="form-control" type="number" id="qty" name="qty"  onkeypress="return isNumber(event)" required /></div></td>
						</tr>
