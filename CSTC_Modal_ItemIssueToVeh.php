...
<head>
	<meta charset="utf-8" />
	<title>Item Issue to Vehicle</title>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Material Issue to Vehicle</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_ItemIssueToVeh.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    <legend style="color:white;"> </legend>
                                    <table align='center'style="color:black;">
                            <tr>
                                <td width="10%"></td>
                                <td align='right' ><h5>SELECT DATE OF ISSUE:</h5></td>
                                <td >
                                    <div class="form-group" style="width:230px;">
                                                ...
                                                <i class="fa fa-calendar"></i>
                                                    ...
                                                    <div class="col-md-12">
                                                <input class="form-control"type="text" name="issue_date1"class="form-control pull-right" id="issue_date1"placeholder="Select Date" maxlength="40" size="20" readonly="yes" >
                                                    </div>
                                                    </div>
                                                </div>
                                </td>
