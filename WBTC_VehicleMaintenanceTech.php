...
require_once('Connections/cstccon.php'); 
 ...
 $maint_type = 3;
 $maint_disp = 'TECHNICAL MAINTENANCE';
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Technical Maintenance  </li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Technical Maintenance <small>Detail List</small></h1>
			<!-- end page-header -->
                            ...
                            <div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="WBTC_VehicleMaintenanceTechAdd.php"  enctype="multipart/form-data">
...
<table id="data-table" class="table table-striped table-bordered"  style="font-size: 10px">                            
                            ...
                            <tbody>
								<?php
								///session_start();
                                                                $sql_itm="SELECT * FROM cstcmis.maint_tran WHERE maint_code = 3 and depot ='" . $_SESSION['UNIT'] . "' and maint_date BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <h4 class="modal-title">
                                                                                <span style="color:black;">
                                                                                    <?php echo "Are you Sure you want Delete? VEHICLE = " . $vehno ; ?>
                                                                                </span>
                                                                            </h4>
                                                                           </div>
                						<hr>
								...
								<button class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">No</button>
                                                                <a href="WBTC_VehicleMaintenanceTechDel.php<?php echo '?maint_id='.$id3; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
                                                                    </div>
