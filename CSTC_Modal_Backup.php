                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Backup Data</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_backup.php"  enctype="multipart/form-data">
                                ...
                                <button type="submit" name="Submit" class="btn btn-success">Start Backup</button>
                                </div>
                            </form>
