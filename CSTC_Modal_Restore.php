...
<head>
	<meta charset="utf-8" />
	<title>Depot Stock Update</title>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Restore from Backup</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_restore.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                        <td>
                                            <?php $sql_itmz="SELECT * FROM last_backup where LAST_DONE = (SELECT MAX(LAST_DONE) FROM last_backup)";
                                    $result_itmz=mysqli_query($cstccon,$sql_itmz);
                                    $rowitmz = mysqli_fetch_array($result_itmz);
                                    $last_done = $rowitmz['LAST_DONE'];
                                    $userid = $rowitmz['USERID'];
                                    
                                    
                                        echo "LAST BACKUP DONE ON " .  $last_done . " BY USER " . $userid; ?>
                                        </td>
                                    </tr>
                                    </table>
                                </div>
                                ...
                                <button type="submit" name="Submit" class="btn btn-success">Start Restore</button>
                                </div>
                            </form>
