...
$CUR_FIN_YR = $_SESSION['CUR_FIN_YR'];
  $sql_itmG2="SELECT B.FIN_YR,A.SBGRP_ID SBGRP_ID1,SUM(B.OPNG_VAL) OPNG_VAL1,SUM(B.RCT_VAL) RCT_VAL1,SUM(B.ISS_VAL) ISS_VAL1,B.FIN_YR FINYR1 FROM itm A, bincrd B where A.PART_NO = B.PART_NO GROUP BY B.FIN_YR,A.SBGRP_ID,B.FIN_YR HAVING B.FIN_YR > 0 ORDER BY A.SBGRP_ID";
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr rowspan='1'>
                            <th style='text-align:center'>FINANCIAL YR.</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $iss_val_tot  = $iss_val_tot  +  $rowx2['ISS_VAL1']; 
                                         ...
                                         $fin_prev = $fin -1 ;
                                         if(strlen($fin_prev) == 1){
                                             $fin_prev = '0' . $fin_prev ;
                                         }
                                         echo '20' . $fin_prev . '-' . '20' . $fin ;
                                         echo "</td>";
