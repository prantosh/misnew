	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
					...
					<table class="table1">
						...
						<tr>
							<td><label style="color:red; font-size:18px;">ROUTE NUMBER :</label></td>
							<td width="30"></td>
							<td><select name="rt_no" id="rt_no">
                                                            <?php do {?>
						...
						<tr>
							<td><label style="color:red; font-size:18px;">TERMINUS :</label></td>
							<td width="30"></td>
							<td><select name="terminus"id="terminus">
                                                                <?php
do {  
?>
...
?>
                                                ...
                                                <tr>
							<td><label style="color:red; font-size:18px;">DEPOT :</label></td>
							<td width="30"></td>
...
?>
						...
						<tr>
							<td><label style="color:red; font-size:18px;">SHIFT :</label></td>
							<td width="30"></td>
							<td><input type="text" id="shift" name="shift" placeholder="Shift" onkeypress="return isNumber(event)" required /></td>
						</tr>
                                                <tr>
							<td><label style="color:red; font-size:18px;">TRIP :</label></td>
							<td width="30"></td>
							<td><input type="text" id="trip" name="trip" placeholder="Trip No." onkeypress="return isNumber(event)" required /></td>
						</tr>
                                                <tr>
							<td><label style="color:red; font-size:18px;">DEPOT CAR NO. :</label></td>
							<td width="30"></td>
							<td><input type="text" id="car_no_depot" name="car_no_depot" placeholder="Car no. Depot" onkeypress="return isNumber(event)" required /></td>
						</tr>
                                                <tr>
							<td><label style="color:red; font-size:18px;">TERMINUS CAR NO. :</label></td>
							<td width="30"></td>
							<td><input type="text" id="car_no_terminus" name="car_no_terminus" placeholder="Car No.Terminus" onkeypress="return isNumber(event)" required /></td>
						</tr>
                                                
                                                <tr>
							<td><label style="color:#3a87ad; font-size:18px;">DEPT. TIME(HR)</label></td>
							<td width="30"></td>
                      ...
                      <option value="24">24</option>
                                                ...
                                                <tr>
							<td><label style="color:#3a87ad; font-size:18px;">DEPT.TIME (MIN)</label></td>
							<td width="30"></td>
							<td><select name="minute1"id="minute1">
