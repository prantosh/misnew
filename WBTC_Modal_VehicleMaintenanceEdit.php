...
$id_new=$_GET['id_maint'];

$unit = $_SESSION['UNIT'];
$user_id = $_SESSION['USER_ID'];

 $query=mysqli_query($cstccon,"select * from cstcmis.maint_tran where id='$id_new' ")or die(mysqli_error());
$row=mysqli_fetch_array($query);
$vehno = $row['vehno'];
$maint_code = $row['maint_code'];

$query_Recordset = "SELECT * from cstcmis.maint_master where maint_code = '" . $maint_code . "'";
$Recordset = mysqli_query($cstccon,$query_Recordset) or die(mysqli_error());
$row_Recordset = mysqli_fetch_assoc($Recordset);
$maint_desc = $row_Recordset['maint_desc'];
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<?php  include('WBTC_VehicleMaintenance.php'); ?>
		<!-- begin #content -->
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="post" action="WBTC_VehicleMaintenanceEdit.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
					<table style="color:black" >
						<tr>
                                                    <td width="5%"></td>
							<td >SELECT MAINTENANCE DATE</td>
							...
							<td><div class="col-md-14">
                                                                <select class="form-control"name="veh" id="veh">
                                                                   
                                                                    <option value="<?php echo $vehno ; ?>"><?php echo $vehno ; ?> </option>
                                <?php
do {  
?>
...
?></select></div></td>
							...
							<td><div class="col-md-14">
                                                                <select class="form-control"name="maint_code" id="maint_code">
                                                                    <option value ="<?php echo $maint_code ; ?>"><?php echo $maint_desc ; ?> </option>
                           <?php do {  ?>
                                    ...
                                    <input name = "id_new1" type="hidden" value="<?php echo $id_new ; ?>"></input>		
