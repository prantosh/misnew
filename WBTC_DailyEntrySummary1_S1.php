...
<p></p>   
DAILY ATTENDANCE ENTRY - SHIFT-I
<p></p>
 <div class="panel panel-warning">
                        <div class="panel-heading">
                            ...
                            <a href="WBTC_Modal_DailyEntrySummary_S1.php" class="btn btn-info" role="button">ADD ATTENDANCE FOR TODAY (1ST SHIFT)</a>
...
<table id="data-table" class="table table-striped table-bordered"  style="font-size: 10px" >                            
                            <thead>
                                <tr>
                                    ...
                                    <th colspan='4'style="text-align:center;">PRESENT 1ST SHIFT</th>

                                    
                                  
                                   
                                    <th colspan='4'style="text-align:center;">ABSENT 1ST SHIFT</th>
                            ...
                            <tbody>
								...
								<td style="text-align:center; "> <?php echo $row ['op_date']; ?></td>
                                                                <td style="text-align:center; "> <?php echo $row ['att_driver_1st']; ?></td>
								<td style="text-align:center; "> <?php echo $row ['att_driver_tr_1st']; ?></td>
								<td style="text-align:center; "> <?php echo $row ['att_cond_1st']; ?></td>
								<td style="text-align:center; "> <?php echo $row ['att_cond_tr_1st']; ?></td>
                                                                <td style="text-align:center; "> <?php echo $row ['ab_driver_1st']; ?></td>
								<td style="text-align:center; "> <?php echo $row ['ab_driver_tr_1st']; ?></td>
								<td style="text-align:center; "> <?php echo $row ['ab_cond_1st']; ?></td>
								<td style="text-align:center; "> <?php echo $row ['ab_cond_tr_1st']; ?></td>
                                                                ...
                                                                <?php    $sql_itm1="SELECT datediff(now(),'" . $row ['op_date'] . "') days FROM cstcmis.daily_record_sum WHERE id =" . $id ;
                                                                    ...
                                                                    <a href="WBTC_Modal_DailyEntrySummaryEdit_S1.php<?php echo '?id='.$id; ?>" class=" btn-info">EDIT</a>
