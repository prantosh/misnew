...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Change Email Address</span></h4>
                            </div>
                            <form method="POST" action="CSTC_EmailChange.php"  enctype="multipart/form-data">
                    ...
                    <tr>
                        <td colspan='2'align='center'><h5></h5></td>
                    </tr><tr><td colspan="2"><p></p></td></tr>
                    <tr>
                        <td  style="color:blue">TYPE EMAIL ADDRESS :</td>
                      <td><input class="form-control"type='email' name='email' id ='email'></input></td>
                    </tr>
                    <tr><td colspan="2"><p></p></td></tr>
                    
                    <tr>
                        <td  style="color:blue">TYPE EMAIL ADDRESS AGAIN :</td>
                      <td><input class="form-control"type='email' name='email1' id ='email'></input></td>
                    </tr>
                    <tr><td colspan="2"><p></p></td></tr>
                                    </table>
                                </div>
...
<button type="submit" class="btn btn-success" onclick="location.href='ST_ItemQuery.php?q='+ document.getElementById('folio_no').value;"> Change EMail Address</button>                                </div>
                            </form>
