                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">DEPOT STOCK UPDATE</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_DepotSpareUpdate.php"  enctype="multipart/form-data">
						...
						<select class="form-control"name="unit_to_update" id="unit_to_update">
	  					...
	  					$row_Recordsetunit1 = mysqli_fetch_assoc($Recordsetunit1);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control"type='text' name='folio_no' id='folio_no' maxlength="7"/>
                                        </td>
                                        <td>
                                    </tr>
                                    <tr><td colspan="2"><p></p></td></tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control"type='text' name='stock' id='stock' maxlength="7"/>
                                        </td>
                                        <td>
                                    </tr>
                                    <tr><td colspan="2"><p></p></td></tr>
