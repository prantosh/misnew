...
$query_Recordsetunit_without_current_depot = "SELECT * FROM unit where UNIT != '" . $unit . "'";
...
<head>
	<meta charset="utf-8" />
	<title>Change Default Depot</title>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">CHANGE DEFAULT DEPOT</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="WBTC_ChangeDefaultDepot.php"  enctype="multipart/form-data">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10">
						<select class="form-control"name="unit_to_change" id="unit_to_change">
                                               
                                            <?php
                                            do {  ?>
                                                <option value="<?php echo $row_Recordsetunit1['UNIT']?>"><?php echo $row_Recordsetunit1['UNIT_DESC']?></option>
                                            <?php
	  					...
	  					$row_Recordsetunit1 = mysqli_fetch_assoc($Recordsetunit1);
                                ...
                                <button type="submit" name="Submit" class="btn btn-success">Change Default Depot</button>
                                </div>
                            </form>
                        </div>
                    </div>
