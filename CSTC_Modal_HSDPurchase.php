                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Procurement of HSD from IOCL/HPCL/BPCL</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_HsdIssueOtherDepot.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                <td width="10%"></td>
                                <td align='right' style="color:olive"><h6>SELECT DATE OF RECEIVE:</h6></td>
                                <td >
                                  <div class="form-group" style="width:230px;">
                                                ...
                                                <i class="fa fa-calendar"></i>
                                                    ...
                                                    <div class="col-md-12">
                                                <input class="form-control"type="text" name="issue_date61"class="form-control pull-right" id="issue_date61"placeholder="Select Date" maxlength="40" size="20" readonly="yes" >
                                                    </div>
                                                    </div>
                                                </div>
                                </td>
                            ...
                            <tr>
                                <td width="10%"></td>
                                <td align='right' style="color:olive"><h6>QUANTITY (Lit):</h6></td>
                                <td >
                                  <input class="form-control"type='text' name='hsd_qty' id='hsd_qty'>
                                </td>
                            </tr>
                                    </table>  
                                    <div align='center'>
