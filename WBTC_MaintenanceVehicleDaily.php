                                  ...
                                  <?php                       
                                                               ...
                                                               $result=mysqli_query($cstccon,$query);
                                                                ...
                                                                while ($row= mysqli_fetch_array ($result) ){
                                                                    ...
                                                                    $query1 = "SELECT b.maint_desc maint_desc1,a.maint_date maint_date1, a.maint_at_km maint_at_km1  from cstcmis.maint_tran a,cstcmis.maint_master b WHERE b.maint_code in (3,4) and a.maint_code = b.maint_code and DATE_FORMAT(a.maint_date,'%m%y')  = '" . $mth .  "' and a.vehno = '" . $row ['vehno'] . "'" ; 
                                                                    $result1=mysqli_query($cstccon,$query1);
