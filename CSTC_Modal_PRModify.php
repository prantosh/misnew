                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Update Purchase Requisition</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_PRModify.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                            <td width='20%'></td>
                                            <td align='left'><h5>PURCHASE REQUISITION NO.:</h5></td>
                                            <td >
                                                <div class="col-md-10">
                                                <input class="form-control"type='text' name='pr_no1' id='pr_no1'>
                                                </div>
                                                </td>
                                        </tr>
                                    </table>
