                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">TIME TABLE MODIFICATION</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="WBTC_MasterTimeTable.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                        <td>
                                            SELECT ROUTE FOR TIME TABLE :
                                        </td>
                                        <td>
                                             
                                            <div class="form-group">
                                                <div class="col-md-10">
						<select name="rt_no" id="rt_no">
                                                            <?php do {?>
