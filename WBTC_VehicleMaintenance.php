...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Vehicle Maintenance <small>Detail List</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="post" action="WBTC_VehicleMaintenanceAdd.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
					<table style="color:black" >
						<tr>
                                                    <td width="5%"></td>
							<td >SELECT DATE OF MAINTENANCE</td>
							...
							<td >
                                                ...
                                                <i class="fa fa-calendar"></i>
                                                    ...
                                                    <div class="col-md-14">
                                                <input class="form-control"value="<?php echo date('d-m-Y',strtotime("-1 days")) ; ?>"type="text" class="form-control" id="ref_date" name="ref_date"placeholder="Select Date" readonly="yes" />
                                                    </div>
                                                </div>
                                                </div>
                                            </td>
							...
							<td><div class="col-md-14"><select class="form-control"name="vehno" id="vehno">
                            <?php
do {  
?>
                                                ...
                                                <tr>
							<td width="5%"></td>
                                                    <td>SELECT MAINTENANCE DESCRIPTION :</td>
							
							<td><div class="col-md-14"><select class="form-control"name="maint_code" id="maint_code">
                           <?php while ($row2 = mysqli_fetch_assoc($Recordset2)) {  ?>
                                                            <option value=" <?php echo  $row2['maint_code']; ?> "> <?php echo $row2['maint_desc']; ?>  </option>
                                                            <?php                            
                                                            } ;
...
<table id="data-table" class="table table-striped table-bordered"  style="font-size: 10px">                            
                            <thead>
                                <tr style="font-size: 8">
                                    ...
                                    <th style="text-align:center;">AT K.M.<i class="fa fa-fw fa-sort"></i></th>
                            ...
                            <tbody>
								<?php
								///session_start();
                                                                $sql_itm="SELECT * FROM cstcmis.maint_tran WHERE depot ='" . $_SESSION['UNIT'] . "' and maint_date BETWEEN CURDATE() - INTERVAL 30 DAY AND CURDATE()";
								...
								<td style="text-align:center; word-break:break-all; "> <?php echo $row ['maint_at_km']; ?></td>
								<?php
                                                                 $sql_itm2="SELECT maint_desc FROM cstcmis.maint_master WHERE maint_code = " . $row['maint_code'] ;
                                                                $result2=mysqli_query($cstccon,$sql_itm2);
                                                                $row2= mysqli_fetch_array ($result2);?>
                                                                
                                                                
                                                                <td style="text-align:center; word-break:break-all; "> <?php echo $row2 ['maint_desc']; ?></td>
								...
								<button class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">No</button>
                                                                <a href="WBTC_VehicleMaintenanceDel.php<?php echo '?maint_id='.$id3; ?>" class="btn btn-danger">Yes</a>
								</div>
								</div>
								</div>
                                                                    </div>
