...
<head>
	<meta charset="utf-8" />
	<title>Modify Existing Route</title>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Modify Existing Route</span></h4>
                            </div>
                            <form method="post" action="WBTC_RouteMasterMod.php"  enctype="multipart/form-data">
					<table class="table1">
