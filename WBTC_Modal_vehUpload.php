	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h5 class="modal-title"><span style="color:white;">UPLOAD DAILY VEHICLE FILE</span></h5>
                            </div>
        ...
        <div class="modal-body"style="color:white ;background-color: #dbda97;">
					...
					<td style="color:BLACK; font-size:12px;">SELECT DATE</td>
                                    ...
                                    <tr>
                                        <td width="30"></td>
                                        <td style="color:BLACK; font-size:12px;">SELECT FILE (veh.csv) TO UPLOAD</td>
