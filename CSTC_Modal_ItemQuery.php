		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="GET" action="CSTC_ItemQuery.php?q=' + document.getElementById('po_no').value'"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                <td align='right'width='50%'><h5></h5></td>
                                <td width='50%'>
                                    <?php     
                                      $sql1="delete FROM itemtemp";
                                                $Recordset1=mysqli_query($cstccon,$sql1);
                                      $sql2="insert into itemtemp(ITEM_NO) SELECT PART_NO FROM itm";
                                                $Recordset2=mysqli_query($cstccon,$sql2);
                                      $sql21="insert into itemtemp(ITEM_NO) SELECT ALT_NO_3 FROM current_part_no";
                                                $Recordset21=mysqli_query($cstccon,$sql21); ?>
                                      Type Folio No./ Part No.
                                     <input class="form-control" name="folio_no"id="folio_no" autofocus="autofocus"value=''>
...
<button  id="submit"type="submit" class="btn btn-success" onclick="location.href='ST_ItemQuery.php?q='+ document.getElementById('folio_no').value;"> SHOW</button>                                </div>
                            </form>
