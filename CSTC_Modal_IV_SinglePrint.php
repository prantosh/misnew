		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="GET" action="CSTC_IV_SinglePrint.php?q= + document.getElementById('var2').value"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    <legend style="color:white;"> </legend>
                                    <table align='center'style="color:black;">
                            <tr>
                                            <td align='right'width='50%'><h5>ISSUE VOUCHER NO.:</h5></td>
                                            <td width='50%'>
                                                <input class="form-control"type='text' name='var2' id='var2'>
				            </td>
