                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Receipt Detail </span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_DailyReceiptReport.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                <td width="10%">
                                <td align='left'width='50%'><h5>SELECT DATE OF RECEIPT:</h5></td>
                                <td width='50%'>
                                    <div class="form-group" style="width:230px;">
                                                ...
                                                <i class="fa fa-calendar"></i>
                                                    ...
                                                    <div class="col-md-12">
                                                <input class="form-control"type="text" name="receipt_date"class="form-control pull-right" id="receipt_date"placeholder="Select Date" maxlength="40" size="20" readonly="yes" >
                                                    </div>
                                                    </div>
                                                </div>
                                </td>
