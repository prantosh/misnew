		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="indent_form" method="post" action="CSTC_DailyMaintenanceEntry.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                        <td colspan='2'>
                            <h6>DAILY MAINTENANCE AND OUTSHEDDING :</h6>
                        </td>
                        <p></p>
                    </tr>
                    <tr>
                      ...
                      <td width="100%" >
                            <select name="maint_tp" id="maint_tp">
                                            
					   <option value="3">TECHNICAL MAINTENANCE</option>
                                           <option value="4">NON-TECHNICAL MAINTENANCE</option>
                                           <option value="5">OUT-SHEDDING DONE</option>
                                          <option value="39">MOBILE ALLOTMENT</option>
                                                    </select>               
                    ...
                    <tr>
                      ...
                      <td width="100%"  class="style2" style="color:#000000;font-weight:bold">
                           <p align="center">MAINTENANCE DATE :  
