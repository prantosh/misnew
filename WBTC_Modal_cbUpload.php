                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h5 class="modal-title"><span style="color:white;">UPLOAD DAILY PERFORMANCE FILE</span></h5>
                            </div>
                            <form method="post" action="uploadercb.php"  enctype="multipart/form-data">
        <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                <table>
                                    <tr>
                                        <td width="30"></td>
					<td style="color:BLACK; font-size:12px;">SELECT DATE</td>
                                    ...
                                    <tr>
                                        <td width="30"></td>
                                        <td style="color:BLACK; font-size:12px;">SELECT FILE (cb.csv) TO UPLOAD</td>
                                        <td><input type="file" name="fileToUpload" id="fileToUpload"><P></P></td>
                                    </tr>
                                </table>
            <p></p>
