...
<head>
	<meta charset="utf-8" />
	<title>WBTC Admin | 404 Error Page</title>
...
<body class="pace-top bg-grey-800">
	<!-- begin #page-loader -->
	<div id="page-loader">
        ...
        <div class="error">
            ...
            <div class="error-content bg-grey-700">
                ...
                <div class="error-desc m-b-20">
                    Either the page you're looking for doesn't exist or you are not authorised to access the page <br />
                    
                </div>
                <div>
                    <a href="index.php" class="btn btn-inverse text-yellow"><i class="material-icons pull-left f-s-18 m-t-1 m-r-5">arrow_back</i> Back to Home Page</a>
                </div>
            </div>
        </div>
        <!-- end error -->
