	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Change Password</span></h4>
                            </div>
                            <form method="POST" action="CSTC_PasswordChange.php"  enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td><input class="form-control"type='password' name='pass_old' id ='vehno'></input></td>
                    </tr>
                    <tr><td colspan="2"><p></p></td></tr>
                    
                    <tr>
                        <td  >Type New Password :</td>
                      <td><input class="form-control"type='password' name='pass_new1'></input></td>
                    </tr>
                    <tr><td colspan="2"><p></p></td></tr>
                    <tr>
                        <td  >Type New Password Again :</td>
                      <td><input class="form-control"type='password' name='pass_new2' ></input></td>
                    </tr>
                    <tr><td colspan="2"><p></p></td></tr>
                                    </table>
                                </div>
...
<button type="submit" class="btn btn-success" onclick="location.href='ST_ItemQuery.php?q='+ document.getElementById('folio_no').value;"> Change Password</button>                                </div>
                            </form>
