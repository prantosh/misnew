		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="GET" action="CSTC_PurchaseOrder_SinglePrint.php?q= + document.getElementById('var1').value"  enctype="multipart/form-data">
                            ...
                            <tr>
                                            ...
                                            <td width='50%'>
                                                <input class="form-control"type='text' name='var1' id='var1'>
				            </td>
