...
<head>
	<meta charset="utf-8" />
	<title>Cofirmation of Data Entry</title>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Add / Update Record</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_MainMenu.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                            <td width='20%'></td>
                                            <td align='left'><h5>RECORD HAS BEEN ADDED / UPDATED SUCCESSFULLY</h5></td>
                                            <td >
                                                <div class="col-md-10">
