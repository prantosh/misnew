...
<head>
	<meta charset="utf-8" />
	<title>Create Purchase Order Delivery Schedule</title>
		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="GET" action="CSTC_POSchedule.php?q=' + document.getElementById('po_no').value'"  enctype="multipart/form-data">
