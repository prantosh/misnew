		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="GET" action="CSTC_ItemQueryDepot.php?q=' + document.getElementById('po_no').value'"  enctype="multipart/form-data">
...
<button type="submit" class="btn btn-success" onclick="location.href='ST_ItemQuery.php?q='+ document.getElementById('folio_no').value;"> SHOW</button>                                </div>
                            </form>
