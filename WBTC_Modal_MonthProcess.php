                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">MONTH DATA PROCESSING</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="WBTC_MthProcess_ajax.php"  enctype="multipart/form-data">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10">
						<input class='form-control'name='mth' id='mth' type='text'length='4'maxlength='4'/>
                                            </div></div>
                                        </td>
                                    </tr>
                                ...
                                <button type="submit" name="Submit" class="btn btn-success">Start processing</button>
                                </div>
                            </form>
                        </div>
                    </div>
