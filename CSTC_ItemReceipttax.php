            ...
            <td>
                        ...
                        <tr>
                           <th style="text-align:center;color:black"><b>SRL</b> </th>
                                    ...
                                    <th style="text-align:center;color:black;"><b>CD(%)</b> </th>
...
<?php
		...
		<td style="color:black;text-align:right; word-break:break-all; "> <?php echo $row['PO_QTY']; ?></td>
                ...
                <td style="color:black;text-align:right; word-break:break-all; "> <?php echo $row['cd']; ?></td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                ...
                                <form action="CSTC_ItemReceipttax_ajax.php" method="POST" class="form">
                                <p></p>
                                    <div  align='center'>
                                    <span align='left' class="input-group-btn" style="width:0px;color:black;">CASH DISCOUNT (%)  :</span>
  <input class="form-control"name='cd'type="text" class="form-control input-sm" value="<?php echo $cd ; ?>" placeholder="Cash Discount %"style="margin-left:-1px" />
     </div>
                                    <p></p>
                                <
                                    <p></p>
