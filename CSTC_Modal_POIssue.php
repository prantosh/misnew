		...
		<div class="modal modal-warning fade" id="modal-warning171" data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="indent_form" method="post" action="CSTC_POIssue.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        <tr>
                                            <td align='right'width='50%'><h5>Vendor ID :</h5></td>
                                            <td width='50%'>
                                                <div class="col-md-8">
                                            <input class="form-control"type='text' name='vnd_id1' id='vnd_id1'>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align='right'width='50%'><h5>Purchase Order No.:</h5></td>
                                            <td width='50%'>
                                                <div class="col-md-8">
