                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">PO Mode Modify</span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_POModeChange.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    ...
                                    <table align='center' width = '80%'style="color:black ;">
                                        ...
                                        <td>
                                            <input class="form-control"type='text' name='po_no_mod' id='po_no_mod' maxlength="7"/>
                                        </td>
                                        <td>
                                    </tr>
                                    </table>
