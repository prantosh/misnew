...
var handleDatepicker = function() {
    ...
    $('#datepicker-default3').datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "dd-mm-yyyy",endDate: new Date() 
    });
    $('#indent_ref_date').datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "dd-mm-yyyy",endDate: new Date() 
    });
    
    $('#indent_ref_date1').datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "dd-mm-yyyy",endDate: new Date() 
    });
    ...
    $('#depot_receive_date').datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "dd-mm-yyyy",endDate: new Date() 
    });
    $('#issue_date61').datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "dd-mm-yyyy",endDate: new Date() 
    });
    $('#issue_date6').datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "dd-mm-yyyy",endDate: new Date() 
    });
...
var handleDateRangePicker = function() {
    ...
    $('#advance-daterange1 span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
    ...
    $('#advance-daterange').daterangepicker({
        ...
        ranges: {
           ...
           'Last 50 Days': [moment().subtract(29, 'days'), moment()],
    ...
    $('#advance-daterange1').daterangepicker({
        format: 'MM/DD/YYYY',
        startDate: moment().subtract(29, 'days'),
        endDate: moment(),
        minDate: '01/01/2012',
        ...
        $('#advance-daterange1 span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
    });
};
