...
//$v_no_add = $_SESSION['v_no'] ;
$v_no_add=htmlspecialchars($_POST['v_no'],ENT_QUOTES);
if($v_no_add != ''){
...
<?php 
 ...
 $query11 = "delete from item_return";
...
$query_Recordset1 = "select PART_NO  from bintxnitm where BNTXN_ID = '" . $v_no_add . "' AND QTY_RETURN_STAT = 'N'";
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
		...
		<?php  include('CSTC_left.php'); ?>
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Goods Return <small>From Issued Voucher</small></h1>
			<!-- end page-header -->
            ...
            <div class="col-md-12" >	
                ...
                <h6><span style="color: white;" align="left"><?php echo  "MATERIAL RETURN FROM  <b>". $unit_to_desc . "</b> To <b>" . $unit_from_desc . "</b>"  ; ?> </span></h6>
                        </div>
		<!-- begin #content -->
  		...
  		<table align='center' color='black'valign = 'top'  border="0" width="100%"  style="background-color: lightgrey">
                    <tr>
                        <td colspan='3' align='center'>
                                    ...
                                    echo 'Modifying Issued Quantity in Existing Voucher No. ' . $v_no_add . ' , ' . date('jS F Y') ;    
                                    }
                                        ?>
                                        </font></h5>
                        </td>
                    ...
                    <tr>
                        ...
                        <td COLOR='black'align='left'>
                                    <div class="col-md-4">
                                        <select  class="form-control" name="folio_no1" id="folio_no1">
                                        <?php
                                        do {  
                                        ?>
                                        <option value="<?php echo $row_Recordset1['PART_NO']?>"><?php echo $row_Recordset1['PART_NO']?></option>
                                        <?php
                    ...
                    <tr> 
                            ...
                            <tr>
                                ...
                                <td   align='right'><h6><font color="#000">QUANTITY TO RETURN:</font></h6></td>
                                <td>
                                    <div class="col-md-4">
                                    <input class="form-control"id="qty_to_return"name="qty_to_return" type="number" size = "8" tabindex="1"/>
                                    </div>
                                            </td>
                                <td></td>
                            </tr>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td align="left">
                                    ...
                                    <input name="Issue" class="btn btn-success"type="button" id="issue"  value="Return" tabindex="2"/>
...
{       
  ...
  $("#login_form").submit(function()
        ...
        $("#issue").click(function()
	{
		...
		//check the username exists or not from ajax
		$.post("CSTC_DepotQryNew1Return_ajax.php",{v_no_add1:$('#v_no_add1').val(),unit_from_new:$('#unit_from_new').val(), unit_to_new:$('#unit_to_new').val(),folio_no1:$('#folio_no1').val(),qty_to_return:$('#qty_to_return').val(),rand:Math.random() } ,function(data)
                //$.post("ST_DepotQryNew_ajax.php",{ folio_no1:$('#folio_no1').val(),rand:Math.random() } ,function(data)
         ...
         $("#Print").click(function()
	{
                ...
                if (answer){
               document.location='CSTC_ItemReturnVoucher.php?q=<?php echo $v_no_add ; ?>';}
                else{
                exit(); }
