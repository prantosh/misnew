                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" align="left"style="color:white ;background-color: #a8a646;">
                                <img src=images/wbtc.png class="img-circle" alt="User Image"height="42" width="42"><h4 class="modal-title"><span style="color:white;">Return Issued Goods </span></h4>
                            </div>
                            <form id="indent_form" method="post" action="CSTC_ItemReturn.php"  enctype="multipart/form-data">
                                <div class="modal-body"style="color:white ;background-color: #dbda97;">
                                    <legend style="color:white;"> </legend>
                                    <table align='center'style="color:black;">
                            <tr>
                                <td align='right'width='50%'><h5>VOUCHER NO.:</h5></td>
                                <td >
				 <input class="form-control"type='text' name='v_no' id='v_no'>
                                </td>
                            </tr>
